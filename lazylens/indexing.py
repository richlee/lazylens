...
def refresh_source(index: Index, source: SourceConfig) -> IndexReport:
    ...
    removed = index.delete_source_items_not_seen(source.key, refresh.seen_item_keys)
    return IndexReport(changed=changed, unchanged=refresh.unchanged, removed=removed)
